...
<html>
    ...
    <body>
        <h1>Manage Users</h1>
        <p>${username} logged in | <a href="home">Home</a> | <a href="login">Logout</a></p>
        <h2>Users</h2>
        <p>${errorMessage}</p>
        <table>
            <tr>
        ...
        <c:if test="${selectedUser == null}">
            ...
            <form action="users" method="POST">
                ...
                mobile number: <input type="tel" name="phone"><br>
        ...
        <c:if test="${selectedUser != null}">
            ...
            <form action="users" method="POST">
                ...
                mobile number: <input type="tel" name="phone" value="${selectedUser.phone}"><br>
